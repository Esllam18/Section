...
class _StudyViewState extends State<_StudyView> {
        ...
        body: Column(children: [
          ...
          SizedBox(
              ...
              child: ListView(
                  ...
                  children: [
                    _yearChip(ctx, null, isAr ? 'الكل' : 'All',
                    ...
                    ...List.generate(
                        ...
                        (i) => _yearChip(
                            ...
                            i + 1,
                            isAr ? 'س ${i + 1}' : 'Y${i + 1}',
                            state.selectedYear == i + 1)),
                  ])),
          Expanded(
              child: switch (state.status) {
            StudyStatus.loading => GridView.builder(
                ...
                itemCount: 8,
                itemBuilder: (_, __) =>
                    const ShimmerWidget(height: 100, borderRadius: 14)),
            StudyStatus.error =>
              ErrorStateWidget(message: state.error ?? 'Error', onRetry: _load),
            _ => state.filtered.isEmpty
                ? Center(
                    child: Text(isAr ? 'لا توجد مواد' : 'No subjects',
                        style: const TextStyle(
                            fontFamily: 'Cairo',
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: c.withOpacity(0.25))),
                                child: Column(
                                    crossAxisAlignment:
                                      ...
                                      Column(
                                          ...
                                          children: [
                                            ...
                                            Row(children: [
                                              ...
                                              Text(
                                                  '${s.resourceCount} ${isAr ? "مصدر" : "resources"}',
                                                  style: TextStyle(
                                                      fontFamily: 'Cairo',
                                                      fontSize: 10,
                                                      color: c))
  ...
  Widget _yearChip(BuildContext ctx, int? year, String label, bool selected) =>
      GestureDetector(
          onTap: () => ctx.read<StudyCubit>().filterYear(year),
